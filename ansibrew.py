...
@cli.command()
def taps():
    """Output a variable for Homebrew taps
    """
    cmd = 'brew tap'
...
@cli.command()
def packages():
    """Output a variable for Homebrew packages
    """
    ...
    # except required packages because they are installed automatically
    excepted_packages = []
    for package in packages:
        ...
        if '==> Dependencies' not in info: continue
...
@cli.command()
def cask():
    """Output a variable for Homebrew cask packages (search packages for all /Applications)
    """
    ...
    # search cask package one-by-one
    ...
    for app in apps:
        ...
        if '==> Exact match' not in res: continue
